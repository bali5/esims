...
import { ElementRef, Input, Output, EventEmitter, Directive, Component, forwardRef, OnChanges, SimpleChange, ViewChildren } from '@angular/core';
...
export class CanvasElement implements OnChanges, AfterViewInit {
